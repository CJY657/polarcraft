...
CREATE TABLE IF NOT EXISTS research_projects (
    ...
    research_questions_zh TEXT COMMENT '研究问题（中文，每行一个）',
    research_hypotheses_zh TEXT COMMENT '研究假设（中文，每行一个）',
    basic_plan_zh TEXT COMMENT '基础问题与实验（中文）',
    extended_plan_zh TEXT COMMENT '拓展问题、假设与实验（中文）',
