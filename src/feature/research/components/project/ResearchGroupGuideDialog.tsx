...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    title: "访客（未登录）",
    paragraphs: [
      "作为访客，你可以自由访问「公开课题」大厅，查看课题方向、议题角色、团队规模、招募状态和已公开的同伴评审记录。公开课题详情页同样提供只读访问，方便你在参与前判断研究方向是否匹配。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "成员可随时选择退出课题。出于课题安全性考虑，成员默认无法修改课题的公开设置、招募规则或执行删除操作。你的「议题角色」标签代表了你在团队中的专长与分工，请务必与组长约定的方向保持对齐。",
    ],
    bullets: [
      "可深度参与讨论、沉淀研究证据、召唤课题 AI 顾问",
      "可基于所分配的议题角色，独立推进实验与数据记录",
  ...
  },
  {
    ...
    bullets: [
      "发现与匹配：浏览公开课题 → 研读议题角色与计划 → 申请加入或独立新建",
