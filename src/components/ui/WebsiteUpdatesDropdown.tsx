...
const WEBSITE_UPDATES: WebsiteUpdate[] = [
  ...
  {
    id: '2026-08-15-research-meetings',
    date: '2026年8月15日',
    title: '课题会议、AI 纪要与成员互评上线',
    description:
      '现在可从“我的课题 → 进入课题 → 会议”集中查看下一次会议、历次安排与归档纪要；组长和管理员还可安排、调整、取消或删除会议。整理会议记录时，可以让 AI 生成一份可编辑的结构化纪要和个人表现反馈，也可以改为手动撰写。纪要归档后，实到成员可对其他实到成员进行匿名星级互评与短评，并在表现榜查看组内前三名和自己的名次。',
    href: '/lab/projects',
  },
];
